/datum/job/rd
	...
	equip(var/mob/living/carbon/human/H)
		...
		switch(H.backbag)
			if(1) H.equip_to_slot_or_del(new /obj/item/storage/box/survival(H), slot_r_hand)
			if(2) H.equip_to_slot_or_del(new /obj/item/storage/backpack/toxins(H), slot_back)
			if(3) H.equip_to_slot_or_del(new /obj/item/storage/backpack/satchel_tox(H), slot_back)
...
//		H.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(H), slot_gloves)
		H.equip_to_slot_or_del(new /obj/item/storage/toolbox/mechanical(H), slot_l_hand)
		if(H.backbag == 1)
