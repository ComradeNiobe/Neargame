...
/mob/living/carbon/human/proc/toggle_outlaw()
	...
	if(master_mode != "minimig")
		if(src.ckey in donation_outlaw)
...
/mob/living/carbon/human/proc/migequip()
	...
	switch(H.migclass)
		if("Adventurer")
			...
			H.my_skills.change_skill(SKILL_MASON, 4)
		...
		if("Mushroomcutter")
			...
			H.my_skills.change_skill(SKILL_CLIMB, rand(3,4))
			H.my_skills.change_skill(SKILL_COOK, rand(0,0))
			H.my_skills.change_skill(SKILL_MASON, 6)
...
/*		if("Mercenary")
		...
		if("Miner")
			...
			H.my_skills.change_skill(SKILL_CLIMB, rand(3,4))
			H.my_skills.change_skill(SKILL_ENGINE, rand(0,0))
			H.my_skills.change_skill(SKILL_MASON, rand(4,5))
			H.my_skills.change_skill(SKILL_CRAFT, 3)
			H.my_skills.change_skill(SKILL_SURG, rand(0,0))
			H.my_skills.change_skill(SKILL_MEDIC, rand(0,0))
			H.my_skills.change_skill(SKILL_CLEAN, rand(0,0))
		...
		if("Engineer")
			...
			H.my_skills.change_skill(SKILL_MASON, 9)
			H.my_skills.change_skill(SKILL_CRAFT, 9)
			H.my_skills.change_skill(SKILL_SURG, rand(0,0))
			H.my_skills.change_skill(SKILL_MEDIC, rand(0,0))
			H.my_skills.change_skill(SKILL_CLIMB, rand(3,4))
			H.my_skills.change_skill(SKILL_CLEAN, rand(0,0))
		...
		if("Alchemist")
			...
			H.equip_to_slot_or_del(new /obj/item/flame/torch/migrant/on(H), slot_r_hand)
			H.my_skills.change_skill(SKILL_MELEE, rand(0,0))
			H.my_skills.change_skill(SKILL_RANGE, rand(0,0))
			H.my_skills.change_skill(SKILL_FARM, rand(0,0))
			H.my_skills.change_skill(SKILL_COOK, rand(0,0))
		...
		if("Blacksmith")
			...
			H.my_skills.change_skill(SKILL_ENGINE, rand(0,0))
			H.my_skills.change_skill(SKILL_MASON, 5)
			H.my_skills.change_skill(SKILL_CRAFT, 7)
			H.my_skills.change_skill(SKILL_SURG, rand(0,0))
			H.my_skills.change_skill(SKILL_MEDIC, rand(0,0))
			H.my_skills.change_skill(SKILL_CLEAN, rand(0,0))
		...
		if("Gemcutter")
			...
			H.my_skills.change_skill(SKILL_COOK, rand(0,0))
			H.my_skills.change_skill(SKILL_ENGINE, rand(0,0))
			H.my_skills.change_skill(SKILL_MASON, 7)
		...
		if("Martial Artist")
			...
			H.my_skills.change_skill(SKILL_CRAFT, 3)
			H.my_skills.change_skill(SKILL_CLIMB, rand(3,4))
			H.my_skills.change_skill(SKILL_UNARM, rand(5,5))
...
//////////////////////////////
	...
	if(ticker.eof.id == "deprived")
		...
		qdel(H.r_hand)
		qdel(H.l_hand)
		H.equip_to_slot_or_del(new /obj/item/flame/torch/migrant/on(H), slot_l_hand)
		qdel(H.wear_id)
		qdel(H.wear_suit)
		qdel(H.shoes)
		qdel(H.glasses)
