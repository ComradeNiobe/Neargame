...
/obj/item/kitchen/utensil/knife/theknife
	name = "The Knife"
	icon = 'icons/obj/weapons.dmi'
	icon_state = "combat"
...
/obj/item/kitchen/utensil/knife/dagger/steel
	name = "steel dagger"
	icon = 'icons/obj/weapons.dmi'
	icon_state = "steeldagger"
	item_state = "dagger"
	force = 21
	throwforce = 16
	drop_sound = 'sound/weapons/knife_drop.ogg'
...
/obj/item/kitchenknife/ritual/attack_self(mob/living/carbon/human/user)
	user.visible_message("<span class='passivebold'>[user]</span> <span class='passive'>cries for the Comatic as they begin to slit their palms.")
	if(do_after(user, 30))
		user.visible_message("<span class='passivebold'>[user]</span> <span class='passive'>slits their palms!")
		user.bloody_hands = 1
		user.bloody_hands()
