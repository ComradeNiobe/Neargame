...
/obj/machinery/computer/hologram_comp/proc/render()
	var/icon/I = new /icon('icons/neargame/zion362/mob/human.dmi', "body_m_s")
	...
	I.Blend(new /icon('icons/neargame/zion362/mob/human.dmi', "mouth_m_s"), ICON_OVERLAY)
	I.Blend(new /icon('icons/neargame/zion362/mob/human.dmi', "underwear1_m_s"), ICON_OVERLAY)
	...
	if (in_range(src, usr))
		...
		if (href_list["power"])
			if (src.projector.hologram)
				...
				src.projector.hologram.icon = 'icons/neargame/zion362/mob/human.dmi'
