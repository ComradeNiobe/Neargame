...
/proc/setupcorpses()
	for (var/obj/effect/landmark/A in landmarks_list)
		...
		//	M.equip_to_slot_or_del(new /obj/item/storage/toolbox/mechanical(M), slot_l_hand)
		...
		if (A.name == "Corpse-Engineer-Space")
			...
			M.death()
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_eng(M), slot_l_ear)
			M.equip_to_slot_or_del(new /obj/item/tank/emergency_oxygen(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/engineer(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/orange(M), slot_shoes)
		...
		if (A.name == "Corpse-Engineer-Chief")
			...
			M.death()
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_eng(M), slot_l_ear)
			M.equip_to_slot_or_del(new /obj/item/storage/utilitybelt(M), slot_belt)
		...
		if (A.name == "Corpse-Syndicate")
			...
			M.death()
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset(M), slot_l_ear)
			//M.equip_to_slot_or_del(new /obj/item/gun/revolver(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/syndicate(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/swat(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/tank/jetpack(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas(M), slot_wear_mask)
			if (prob(50))
