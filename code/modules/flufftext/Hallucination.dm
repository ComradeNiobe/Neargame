			...
			if(66 to 70)
				...
				if(!halbody)
					...
					if(possible_points.len)
						...
						switch(rand(1,4))
							if(1)
								halbody = image('icons/neargame/zion362/mob/human.dmi',target,"husk_l",TURF_LAYER)
							if(2,3)
								halbody = image('icons/neargame/zion362/mob/human.dmi',target,"husk_s",TURF_LAYER)
							if(4)
