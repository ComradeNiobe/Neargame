...
/obj/machinery/computer/rdconsole/interact(mob/user)
	...
	switch(screen)
		...
		if(1.0) //Main Menu
			...
			if(linked_destroy)
				dat += "<A href='byond://?src=\ref[src];menu=2.2'>Destructive Analyzer Menu</A><BR>"
			else
		...
		if(1.3) //Technology Disk submenu
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A>"
			dat += "<A href='byond://?src=\ref[src];menu=1.2'>Return to Disk Operations</A><div class='statusDisplay'>"
			dat += "<h3>Load Technology to Disk:</h3><BR>"
			for(var/datum/tech/T in files.known_tech)
				dat += "[T.name] "
				dat += "<A href='byond://?src=\ref[src];copy_tech=1;copy_tech_ID=[T.id]'>Copy to Disk</A><BR>"
			dat += "</div>"

		if(1.4) //Design Disk menu.
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A><div class='statusDisplay'>"
		...
		if(1.5) //Technology disk submenu
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A>"
			dat += "<A href='byond://?src=\ref[src];menu=1.4'>Return to Disk Operations</A><div class='statusDisplay'>"
			dat += "<h3>Load Design to Disk:</h3><BR>"
			for(var/datum/design/D in files.known_designs)
				dat += "[D.name] "
				dat += "<A href='byond://?src=\ref[src];copy_design=1;copy_design_ID=[D.id]'>Copy to Disk</A><BR>"
			dat += "</div>"
		...
		if(1.6) //R&D console settings
			...
			dat += "<A href='byond://?src=\ref[src];reset=1'>Reset R&D Database</A></div>"

		if(1.7) //R&D device linkage
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A>"
			dat += "<A href='byond://?src=\ref[src];menu=1.6'>Settings Menu</A><div class='statusDisplay'> "
			dat += "<h3>R&D Console Device Linkage Menu:</h3><BR>"
			dat += "<A href='byond://?src=\ref[src];find_device=1'>Re-sync with Nearby Devices</A><BR><BR>"
			dat += "<h3>Linked Devices:</h3><BR>"
			if(linked_destroy)
				dat += "* Destructive Analyzer <A href='byond://?src=\ref[src];disconnect=destroy'>Disconnect</A><BR>"
			else
		...
		if(2.2)
			...
			dat += "</div>Options: "
			dat += "<A href='byond://?src=\ref[src];deconstruct=1'>Deconstruct Item</A>"
		...
		if(3.1)
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A> "
			dat += "<A href='byond://?src=\ref[src];menu=3.2'>Material Storage</A><div class='statusDisplay'>"
			//dat += "<A href='byond://?src=\ref[src];menu=3.3'>Chemical Storage</A><div class='statusDisplay'>"
			...
			for(var/datum/design/D in files.known_designs)
				...
				if (check_materials)
					dat += "* <A href='byond://?src=\ref[src];build=[D.id]'>[temp_dat]</A>[temp_material]"
					dat += " "
					for(var/multiple in list(2,3,5,10))
						dat += "<A href='byond://?src=\ref[src];buildmulti=[D.id];amount=[multiple]'>x[multiple]</A>"
					dat += "<BR>"
				else
		...
		if(3.2) //Protolathe Material Storage Sub-menu
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A>"
			dat += "<A href='byond://?src=\ref[src];menu=3.1'>Protolathe Menu</A><div class='statusDisplay'>"
			dat += "<h3>Material Storage:</h3><BR><HR>"
			//Metal
			dat += "* [linked_lathe.m_amount] of Metal: "
			if(linked_lathe.m_amount >= 3750) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=metal;lathe_ejectsheet_amt=1'>Eject</A> "
			if(linked_lathe.m_amount >= 18750) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=metal;lathe_ejectsheet_amt=5'>5x</A> "
			if(linked_lathe.m_amount >= 3750) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=metal;lathe_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Glass
			dat += "* [linked_lathe.g_amount] of Glass: "
			if(linked_lathe.g_amount >= 3750) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=glass;lathe_ejectsheet_amt=1'>Eject</A> "
			if(linked_lathe.g_amount >= 18750) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=glass;lathe_ejectsheet_amt=5'>5x</A> "
			if(linked_lathe.g_amount >= 3750) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=glass;lathe_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Gold
			dat += "* [linked_lathe.gold_amount] of Gold: "
			if(linked_lathe.gold_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=gold;lathe_ejectsheet_amt=1'>Eject</A> "
			if(linked_lathe.gold_amount >= 10000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=gold;lathe_ejectsheet_amt=5'>5x</A> "
			if(linked_lathe.gold_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=gold;lathe_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Silver
			dat += "* [linked_lathe.silver_amount] of Silver: "
			if(linked_lathe.silver_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=silver;lathe_ejectsheet_amt=1'>Eject</A> "
			if(linked_lathe.silver_amount >= 10000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=silver;lathe_ejectsheet_amt=5'>5x</A> "
			if(linked_lathe.silver_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=silver;lathe_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Plasma
			dat += "* [linked_lathe.plasma_amount] of Solid Plasma: "
			if(linked_lathe.plasma_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=plasma;lathe_ejectsheet_amt=1'>Eject</A> "
			if(linked_lathe.plasma_amount >= 10000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=plasma;lathe_ejectsheet_amt=5'>5x</A> "
			if(linked_lathe.plasma_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=plasmalathe_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Uranium
			dat += "* [linked_lathe.uranium_amount] of Uranium: "
			if(linked_lathe.uranium_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=uranium;lathe_ejectsheet_amt=1'>Eject</A> "
			if(linked_lathe.uranium_amount >= 10000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=uranium;lathe_ejectsheet_amt=5'>5x</A> "
			if(linked_lathe.uranium_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=uranium;lathe_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Diamond
			dat += "* [linked_lathe.diamond_amount] of Diamond: "
			if(linked_lathe.diamond_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=diamond;lathe_ejectsheet_amt=1'>Eject</A> "
			if(linked_lathe.diamond_amount >= 10000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=diamond;lathe_ejectsheet_amt=5'>5x</A> "
			if(linked_lathe.diamond_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=diamond;lathe_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Bananium
			dat += "* [linked_lathe.clown_amount] of Bananium: "
			if(linked_lathe.clown_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=clown;lathe_ejectsheet_amt=1'>Eject</A> "
			if(linked_lathe.clown_amount >= 10000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=clown;lathe_ejectsheet_amt=5'>5x</A> "
			if(linked_lathe.clown_amount >= 2000) dat += "<A href='byond://?src=\ref[src];lathe_ejectsheet=clown;lathe_ejectsheet_amt=50'>All</A>"
			dat += "</div>"

		if(3.3)
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A>"
			dat += "<A href='byond://?src=\ref[src];menu=3.1'>Protolathe Menu</A>"
			dat += "<A href='byond://?src=\ref[src];disposeallP=1'>Disposal All Chemicals in Storage</A><div class='statusDisplay'>"
		...
		if(4.1)
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A>"
			dat += "<A href='byond://?src=\ref[src];menu=4.3'>Material Storage</A><div class='statusDisplay'>"
		//	dat += "<A href='byond://?src=\ref[src];menu=4.2'>Chemical Storage</A><div class='statusDisplay'>"
			...
			for(var/datum/design/D in files.known_designs)
				...
				if (check_materials)
					dat += "* <A href='byond://?src=\ref[src];imprint=[D.id]'>[temp_dat]</A>[temp_materials]<BR>"
				else
		...
		if(4.2)
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A>"
			dat += "<A href='byond://?src=\ref[src];menu=4.1'>Imprinter Menu</A>"
			dat += "<A href='byond://?src=\ref[src];disposeallI=1'>Disposal All Chemicals in Storage</A><div class='statusDisplay'>"
			dat += "<h3>Chemical Storage:</h3><BR><HR>"
		...
		if(4.3)
			dat += "<A href='byond://?src=\ref[src];menu=1.0'>Main Menu</A>"
			dat += "<A href='byond://?src=\ref[src];menu=4.1'>Circuit Imprinter Menu</A><div class='statusDisplay'>"
			dat += "<h3>Material Storage:</h3><BR><HR>"
			//Glass
			dat += "* [linked_imprinter.g_amount]  glass: "
			if(linked_imprinter.g_amount >= 3750) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=glass;imprinter_ejectsheet_amt=1'>Eject</A> "
			if(linked_imprinter.g_amount >= 18750) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=glass;imprinter_ejectsheet_amt=5'>5x</A> "
			if(linked_imprinter.g_amount >= 3750) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=glass;imprinter_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Gold
			dat += "* [linked_imprinter.gold_amount] gold: "
			if(linked_imprinter.gold_amount >= 2000) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=gold;imprinter_ejectsheet_amt=1'>Eject</A> "
			if(linked_imprinter.gold_amount >= 10000) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=gold;imprinter_ejectsheet_amt=5'>5x</A> "
			if(linked_imprinter.gold_amount >= 2000) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=gold;imprinter_ejectsheet_amt=50'>All</A>"
			dat += "<BR>"
			//Diamond
			dat += "* [linked_imprinter.diamond_amount] diamond: "
			if(linked_imprinter.diamond_amount >= 2000) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=diamond;imprinter_ejectsheet_amt=1'>Eject</A> "
			if(linked_imprinter.diamond_amount >= 10000) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=diamond;imprinter_ejectsheet_amt=5'>5x</A> "
			if(linked_imprinter.diamond_amount >= 2000) dat += "<A href='byond://?src=\ref[src];imprinter_ejectsheet=diamond;imprinter_ejectsheet_amt=50'>All</A>"
			dat += "</div>"
