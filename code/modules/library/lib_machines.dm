...
/obj/machinery/librarypubliccomp/attack_hand(var/mob/user as mob)
	...
	switch(screenstate)
		if(0)
			...
			<A href='byond://?src=\ref[src];settitle=1'>d_filter by Title: [title]</A><BR>
			<A href='byond://?src=\ref[src];setcategory=1'>d_filter by Category: [category]</A><BR>
			<A href='byond://?src=\ref[src];setauthor=1'>d_filter by Author: [author]</A><BR>
