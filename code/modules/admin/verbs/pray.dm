...
/proc/Centcomm_announce(var/text , var/mob/Sender , var/iamessage)
	...
	msg = "\blue <b><font color=orange>CENTCOMM[iamessage ? " IA" : ""]:</font>[key_name(Sender, 1)] (<A HREF='byond://?_src_=holder;adminplayeropts=\ref[Sender]'>PP</A>) (<A HREF='byond://?_src_=vars;Vars=\ref[Sender]'>VV</A>) (<A HREF='byond://?_src_=holder;subtlemessage=\ref[Sender]'>SM</A>) (<A HREF='byond://?_src_=holder;adminplayerobservejump=\ref[Sender]'>JMP</A>) (<A HREF='byond://?_src_=holder;secretsadmin=check_antagonist'>CA</A>) (<A HREF='byond://?_src_=holder;BlueSpaceArtillery=\ref[Sender]'>BSA</A>) (<A HREF='byond://?_src_=holder;CentcommReply=\ref[Sender]'>RPLY</A>):</b> [msg]"
	admins << msg
