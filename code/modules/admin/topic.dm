	...
	if(usr.client != src.owner || !check_rights(0))
		...
		switch(href_list["call_shuttle"])
			if("1")
				...
				a.autosay("Alert: The Ulysses is being launched. They will launch in [round(emergency_shuttle.timeleft()/60)] minutes.", "Ulysses Console")
		...
		a.autosay("Alert: The Ulysses will launch in [round(emergency_shuttle.timeleft()/60)] minutes.", "Ulysses Console")
...
//Regular jobs
	...
	//Non-Human (Green)
		counter = 0
		jobs += "<table cellpadding='1' cellspacing='0' width='100%'>"
		jobs += "<tr bgcolor='ccffcc'><th colspan='[length(nonhuman_positions)]'><a href='byond://?src=\ref[src];jobban3=nonhumandept;jobban4=\ref[M]'>Non-human Positions</a></th></tr><tr align='center'>"
	...
	//Antagonist (Orange)
		...
		if(jobban_isbanned(M, "vox") || isbanned_dept)
			jobs += "<td width='20%'><a href='byond://?src=\ref[src];jobban3=vox;jobban4=\ref[M]'><font color=red>[replacetext("Vox", " ", "&nbsp")]</font></a></td>"
		else
			jobs += "<td width='20%'><a href='byond://?src=\ref[src];jobban3=vox;jobban4=\ref[M]'>[replacetext("Vox", " ", "&nbsp")]</a></td>"


/*		//Malfunctioning AI	//Removed Malf-bans because they're a pain to impliment
		if(jobban_isbanned(M, "malf AI") || isbanned_dept)
			jobs += "<td width='20%'><a href='byond://?src=\ref[src];jobban3=malf AI;jobban4=\ref[M]'><font color=red>[replacetext("Malf AI", " ", "&nbsp")]</font></a></td>"
		else
			jobs += "<td width='20%'><a href='byond://?src=\ref[src];jobban3=malf AI;jobban4=\ref[M]'>[replacetext("Malf AI", " ", "&nbsp")]</a></td>"

		//Alien
		if(jobban_isbanned(M, "alien candidate") || isbanned_dept)
			jobs += "<td width='20%'><a href='byond://?src=\ref[src];jobban3=alien candidate;jobban4=\ref[M]'><font color=red>[replacetext("Alien", " ", "&nbsp")]</font></a></td>"
		else
			jobs += "<td width='20%'><a href='byond://?src=\ref[src];jobban3=alien candidate;jobban4=\ref[M]'>[replacetext("Alien", " ", "&nbsp")]</a></td>"

		//Infested Monkey
		if(jobban_isbanned(M, "infested monkey") || isbanned_dept)
			jobs += "<td width='20%'><a href='byond://?src=\ref[src];jobban3=infested monkey;jobban4=\ref[M]'><font color=red>[replacetext("Infested Monkey", " ", "&nbsp")]</font></a></td>"
		else
			jobs += "<td width='20%'><a href='byond://?src=\ref[src];jobban3=infested monkey;jobban4=\ref[M]'>[replacetext("Infested Monkey", " ", "&nbsp")]</a></td>"
*/
		jobs += "</tr></table>"
...
*/
	if(href_list["show_mob_attacklog"])
		...
		S.channel = 703
		usr << S
		usr << "<B><A HREF='byond://?_src_=holder;stoplistensound=1'>Stop listening</A></B>"
