...
/datum/preferences
	...
	proc/ShowChoices(mob/user)
		...
		dat += "<body background = 'bg2.png' bgColor=#0d0d0d text=#555555 alink=#777777 vlink=#777777 link=#777777>"
		dat += "<p style='position: absolute;top: 10;left:295; font-size:400%'><font face='Times'><b>†</b></font></p>"
		dat += "<p align = 'right'><a onfocus='this.blur()' href='byond://?_src_=prefs;preference=toggleLobbyScreen'>¤</a></p>"
...
//			dat += "<br><b>Archetype:</b> <a href='byond://?_src_=prefs;preference=inqui'><b>[InquisiPref]</b></a>"
		if(user?.client?.work_chosen == "Praetor")
		...
		//if(gender == MALE)
		//	dat += "<b>Be Fat:</b> <a onfocus='this.blur()' href='byond://?_src_=prefs;preference=fatness'><b>[fat ? "Yes" : "No"]</b></a><br>"
		//REMOVER ESSE DEPOIS
		dat += "<br>"
		...
		user << browse(HTML_SKELETON_INTERNAL(head, dat), "window=preferences;size=600x400;can_close=0;can_resize=0;titlebar=[toggleLobbyScreen]")
