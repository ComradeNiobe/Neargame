...
datum/reagent/ethylredoxrazine	// FUCK YOU, ALCOHOL
	...
	on_mob_life(var/mob/living/M as mob)
		...
		M.stuttering = 0
		M.confused = 0
		M.reagents.remove_all_type(/datum/reagent/ethanol, 1 * REAGENTS_EFFECT_MULTIPLIER, 0, 1)
		..()
		return
...
datum/reagent/toxin
	...
	on_mob_life(var/mob/living/M as mob)
		if(!M) M = holder.my_atom
		if(toxpwr)
			M.adjustToxLoss(toxpwr * REAGENTS_EFFECT_MULTIPLIER)
		..()
		return
...
datum/reagent/toxin/plasma
	...
	on_mob_life(var/mob/living/M as mob)
		...
		if(holder.has_reagent("epinephrine"))
			holder.remove_reagent("epinephrine", 2 * REAGENTS_EFFECT_MULTIPLIER)
		..()
		return
	reaction_obj(var/obj/O, var/volume)
		src = null
...
// Alcoholism Begins to actually format shit.wav

// BEER

datum/reagent/ethanol/beer/bitterbastard
	name = "Bitter Old Bastard"
	id = "bitterbeer"
	description = "Dark stout noted for its bitter notes."
	color = "#3d231c"
	boozepwr = 1

datum/reagent/ethanol/beer/rahalbeer
	name = "Rahallian Kriek"
	id = "rahalbeer"
	description = "Fruit-sour styled beer from Rahal."
	color = "#2a222e"
	boozepwr = 1

datum/reagent/ethanol/beer/pissbeer
	name = "Gahan Malt"
	id = "maltbeer"
	description = "Malt-style beer from Gahan."
	color = "#ffac4d"
	boozepwr = 1

// WINE

datum/reagent/ethanol/wine/cheapwine
	name = "Cave Wine"
	id = "cheapwine"
	description = "Cheap astringent wine made from mushrooms."
	color = "#150c1f"
	boozepwr = 1.5

datum/reagent/ethanol/wine/standardwine
	name = "Fine Wine"
	id = "standardwine"
	description = "Sweet wine made from adapted cave grapes."
	color = "#2b0912"
	boozepwr = 1.5

datum/reagent/ethanol/wine/vintagewine
	name = "Vintage Wine"
	id = "vintagewine"
	description = "An extremely rare and well-aged vintage. Only for the highest born!"
	color = "#21050c"
	boozepwr = 2