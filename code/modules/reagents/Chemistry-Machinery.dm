...
/obj/machinery/chem_master/attack_hand(mob/user as mob)
	...
	if(!beaker)
		...
		if(src.loaded_pill_bottle)
			dat += "<A href='byond://?src=\ref[src];ejectp=1'>Eject Pill Bottle \[[loaded_pill_bottle.contents.len]/[loaded_pill_bottle.storage_slots]\]</A><BR><BR>"
		else
		...
		if(!condi)
			...
			dat += "<HR><BR><A href='byond://?src=\ref[src];createpatch=1;many=0'>Create patch (50 units max)</A><BR>"
			dat += "<A href='byond://?src=\ref[src];createpatch=1;many=1'>Create patches (10 patches max)</A><BR><BR>"
	...
	if(src.temphtml)
		...
		if(!R.total_volume||!R.reagent_list.len)
			...
			if(Blood.data["resistances"])
				...
				dat += "nothing<BR>"
		dat += "<BR><A href='byond://?src=\ref[src];eject=1'>Eject beaker</A>[((R.total_volume&&R.reagent_list.len) ? "-- <A href='byond://?src=\ref[src];empty_beaker=1'>Empty beaker</A>":"")]<BR>"
		dat += "<A href='byond://?src=\ref[user];mach_close=pandemic'>Close</A>"
...
/obj/machinery/chem_heater/attack_hand(var/mob/user as mob)
	...
	if(!beaker)
		...
		if(!on)
			dat += "<A href='byond://?src=\ref[src];adjust_temperature=1'>Adjust Temperature</A><BR>"
			dat += "<A href='byond://?src=\ref[src];toggle_on=1'>Toggle On</A><BR>"
			dat += "<BR><BR><A href='byond://?src=\ref[src];eject_beaker=1'>Eject beaker</A><BR>"
		else
			dat += "Reagents heating in progress...<BR>"
			dat += "<BR><BR><A href='byond://?src=\ref[src];toggle_on=1'>Toggle Off</A><BR>"
