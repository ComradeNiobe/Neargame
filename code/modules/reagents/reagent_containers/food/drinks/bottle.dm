...
/obj/item/reagent_containers/glass/bottle/pwinecheap
	name = "Little Arlitenyok"
	desc = "Likely the most common type of mass-produced wine on Evergreen. Offensively sweet."
	icon = 'icons/obj/drinks.dmi'
	icon_state = "winebottle"
	item_state = "broken_beer"
	New()
...
/obj/item/reagent_containers/glass/bottle/pwine
	name = "Vintage Wine"
	desc = "Given the destructive nature of Evergreenian life: Such a vintage is a treat only afforded by Lords!"
	icon = 'icons/obj/drinks.dmi'
	icon_state = "winebottle"
	item_state = "broken_beer"
	New()
...
/obj/item/reagent_containers/glass/bottle/beer
	name = "Salar Wheat"
	desc = "Salar Wheat, choice beer for any self-respecting smerd."
	icon = 'icons/obj/drinks.dmi'
	icon_state = "beer"
	item_state = "beer"
	isGlass = 1
...
// ALCOHOLISM ADDS MORE BOOZE


// Beer!

/obj/item/reagent_containers/glass/bottle/rahalkriek
	name = "Rahallian Kriek"
	desc = "A rare style of beer from Rahal. Brewed with fruit for a sour flavour!"
	icon = 'icons/obj/drinks.dmi'
	icon_state = "rahalkriek"
	item_state = "beer"
	isGlass = 1
	New()
		..()
		reagents.add_reagent("rahalbeer", 100)
		src.pixel_x = rand(-10.0, 10)
		src.pixel_y = rand(-10.0, 10)

/obj/item/reagent_containers/glass/bottle/gahanmalt
	name = "Gahan Malt"
	desc = "Gahan-Malt beer. Associated with Evergreenian Rap and Domestic Violence."
	icon = 'icons/obj/drinks.dmi'
	icon_state = "pissbeer"
	item_state = "beer"
	isGlass = 0
	New()
		..()
		reagents.add_reagent("maltbeer", 100)
		src.pixel_x = rand(-10.0, 10)
		src.pixel_y = rand(-10.0, 10)

/obj/item/reagent_containers/glass/bottle/bitterbastard
	name = "Bitter Old Bastard"
	desc = "Legendary dark stout. Bitter with a foamy head, some claim this was brewed in Vranovo before its destruction!"
	icon = 'icons/obj/drinks.dmi'
	icon_state = "bitterbastard"
	item_state = "beer"
	isGlass = 0
	New()
		..()
		reagents.add_reagent("bitterbeer", 100)
		src.pixel_x = rand(-10.0, 10)
		src.pixel_y = rand(-10.0, 10)

// Wine!

/obj/item/reagent_containers/glass/bottle/cwine
	name = "Cave Wine"
	desc = "Cheap, astringent and bitter. Favoured by lesser nobles and tradesmen."
	icon = 'icons/obj/drinks.dmi'
	icon_state = "winebottle"
	item_state = "broken_beer"
	New()
		..()
		reagents.add_reagent("cheapwine", 100)

/obj/item/reagent_containers/glass/bottle/swine
	name = "Little Arlitenyok"
	desc = "Likely the most common type of mass-produced wine on Evergreen. Offensively sweet."
	icon = 'icons/obj/drinks.dmi'
	icon_state = "winebottle"
	...
	New()
		..()
		reagents.add_reagent("standardwine", 100)

/obj/item/reagent_containers/glass/bottle/vwine
	name = "Vintage Wine"
	desc = "Given the destructive nature of Evergreenian life: Such a vintage is a treat only afforded by Lords!"
	icon = 'icons/obj/drinks.dmi'
	icon_state = "winebottle"
	...
	New()
		..()
		reagents.add_reagent("vintagewine", 100)