...
/obj/machinery/mineral/stacking_unit_console/interact(mob/user)
	...
	if(machine.ore_iron)
		dat += text("Iron: [machine.ore_iron] <A href='byond://?src=\ref[src];release=iron'>Release</A><br>")
	if(machine.ore_plasteel)
		dat += text("Plasteel: [machine.ore_plasteel] <A href='byond://?src=\ref[src];release=plasteel'>Release</A><br>")
	if(machine.ore_glass)
		dat += text("Glass: [machine.ore_glass] <A href='byond://?src=\ref[src];release=glass'>Release</A><br>")
	if(machine.ore_rglass)
		dat += text("Reinforced Glass: [machine.ore_rglass] <A href='byond://?src=\ref[src];release=rglass'>Release</A><br>")
	if(machine.ore_plasma)
		dat += text("Plasma: [machine.ore_plasma] <A href='byond://?src=\ref[src];release=plasma'>Release</A><br>")
	if(machine.ore_plasmaglass)
		dat += text("Plasma Glass: [machine.ore_plasmaglass] <A href='byond://?src=\ref[src];release=plasmaglass'>Release</A><br>")
	if(machine.ore_plasmarglass)
		dat += text("Reinforced Plasma Glass: [machine.ore_plasmarglass] <A href='byond://?src=\ref[src];release=plasmarglass'>Release</A><br>")
	if(machine.ore_gold)
		dat += text("Gold: [machine.ore_gold] <A href='byond://?src=\ref[src];release=gold'>Release</A><br>")
	if(machine.ore_silver)
		dat += text("Silver: [machine.ore_silver] <A href='byond://?src=\ref[src];release=silver'>Release</A><br>")
	if(machine.ore_uranium)
		dat += text("Uranium: [machine.ore_uranium] <A href='byond://?src=\ref[src];release=uranium'>Release</A><br>")
	if(machine.ore_diamond)
		dat += text("Diamond: [machine.ore_diamond] <A href='byond://?src=\ref[src];release=diamond'>Release</A><br>")
	if(machine.ore_wood)
		dat += text("Wood: [machine.ore_wood] <A href='byond://?src=\ref[src];release=wood'>Release</A><br>")
	if(machine.ore_cardboard)
		dat += text("Cardboard: [machine.ore_cardboard] <A href='byond://?src=\ref[src];release=cardboard'>Release</A><br>")
	if(machine.ore_cloth)
		dat += text("Cloth: [machine.ore_cloth] <A href='byond://?src=\ref[src];release=cloth'>Release</A><br>")
	if(machine.ore_leather)
		dat += text("Leather: [machine.ore_leather] <A href='byond://?src=\ref[src];release=leather'>Release</A><br>")
	if(machine.ore_clown)
		dat += text("Bananium: [machine.ore_clown] <A href='byond://?src=\ref[src];release=clown'>Release</A><br>")
	if(machine.ore_adamantine)
		dat += text ("Adamantine: [machine.ore_adamantine] <A href='byond://?src=\ref[src];release=adamantine'>Release</A><br>")
	if(machine.ore_mythril)
		dat += text ("Mythril: [machine.ore_mythril] <A href='byond://?src=\ref[src];release=adamantine'>Release</A><br>")
