	...
	if(machine.ore_iron || machine.ore_glass || machine.ore_plasma || machine.ore_uranium || machine.ore_gold || machine.ore_silver || machine.ore_diamond || machine.ore_clown || machine.ore_adamantine)
		if(machine.ore_iron)
			if (machine.selected_iron==1)
				dat += text("<A href='byond://?src=\ref[src];sel_iron=no'><font color='green'>Smelting</font></A> ")
			else
				dat += text("<A href='byond://?src=\ref[src];sel_iron=yes'><font color='red'>Not smelting</font></A> ")
		...
		if(machine.ore_glass)
			if (machine.selected_glass==1)
				dat += text("<A href='byond://?src=\ref[src];sel_glass=no'><font color='green'>Smelting</font></A> ")
			else
				dat += text("<A href='byond://?src=\ref[src];sel_glass=yes'><font color='red'>Not smelting</font></A> ")
		...
		if(machine.ore_plasma)
			if (machine.selected_plasma==1)
				dat += text("<A href='byond://?src=\ref[src];sel_plasma=no'><font color='green'>Smelting</font></A> ")
			else
				dat += text("<A href='byond://?src=\ref[src];sel_plasma=yes'><font color='red'>Not smelting</font></A> ")
		...
		if(machine.ore_uranium)
			if (machine.selected_uranium==1)
				dat += text("<A href='byond://?src=\ref[src];sel_uranium=no'><font color='green'>Smelting</font></A> ")
			else
				dat += text("<A href='byond://?src=\ref[src];sel_uranium=yes'><font color='red'>Not smelting</font></A> ")
		...
		if(machine.ore_gold)
			if (machine.selected_gold==1)
				dat += text("<A href='byond://?src=\ref[src];sel_gold=no'><font color='green'>Smelting</font></A> ")
			else
				dat += text("<A href='byond://?src=\ref[src];sel_gold=yes'><font color='red'>Not smelting</font></A> ")
		...
		if(machine.ore_silver)
			if (machine.selected_silver==1)
				dat += text("<A href='byond://?src=\ref[src];sel_silver=no'><font color='green'>Smelting</font></A> ")
			else
				dat += text("<A href='byond://?src=\ref[src];sel_silver=yes'><font color='red'>Not smelting</font></A> ")
		...
		if(machine.ore_diamond)
			if (machine.selected_diamond==1)
				dat += text("<A href='byond://?src=\ref[src];sel_diamond=no'><font color='green'>Smelting</font></A> ")
			else
				dat += text("<A href='byond://?src=\ref[src];sel_diamond=yes'><font color='red'>Not smelting</font></A> ")
		...
		if(machine.ore_clown)
			if (machine.selected_clown==1)
				dat += text("<A href='byond://?src=\ref[src];sel_clown=no'><font color='green'>Smelting</font></A> ")
			else
				dat += text("<A href='byond://?src=\ref[src];sel_clown=yes'><font color='red'>Not smelting</font></A> ")
		...
		if (machine.on==1)
			dat += text("<A href='byond://?src=\ref[src];set_on=off'>On</A> ")
		else
			dat += text("<A href='byond://?src=\ref[src];set_on=on'>Off</A> ")
	else
