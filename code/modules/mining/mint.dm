...
/obj/machinery/mineral/mint/attack_hand(user as mob) //TODO: Adamantine coins! -Durandan
	...
	if (chosen == "metal")
		...
		dat += text("<A href='byond://?src=\ref[src];choose=metal'>Choose</A>")
	...
	if (chosen == "plasma")
		...
		dat += text("<A href='byond://?src=\ref[src];choose=plasma'>Choose</A>")
	...
	if(amt_clown > 0)
		...
		if (chosen == "clown")
			...
			dat += text("<A href='byond://?src=\ref[src];choose=clown'>Choose</A>")
	...
	if (chosen == "adamantine")
		...
		dat += text("<A href='byond://?src=\ref[src];choose=adamantine'>Choose</A>")
