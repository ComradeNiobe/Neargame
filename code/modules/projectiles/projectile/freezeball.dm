...
/obj/machinery/computer/freezer/proc/return_text()
	...
	if(!slave)
		...
		return text
	if(!slave.on)
		text = "<A href='byond://?src=\ref[src];on=1'>Turn On</A><br>"
	else
		text = "<A href='byond://?src=\ref[src];off=1'>Turn Off</A><br>"
		text += "<A href='byond://?src=\ref[src];freezing=1'>Freezing</A><br>"
	return text
