...
/obj/item/gun/launcher/spikethrower/Del()
...
/obj/item/gun/launcher/spikethrower/examine()
	..()
...
/obj/item/gun/launcher/spikethrower/emp_act(severity)
	return
...
/obj/item/gun/launcher/spikethrower/load_into_chamber()
	if(in_chamber) return 1
	if(spikes < 1) return 0

	spikes--
	in_chamber = new /obj/item/spike(src)
	return 1

/obj/item/gun/launcher/spikethrower/Fire(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, params, reflex = 0)
	if(..()) update_icon()
