...
/proc/play_looping_sound(var/atom/source, var/sound_id, var/sound, var/volume, var/range, var/falloff = 1, var/echo, var/frequency, var/prefer_mute, var/streaming)
	var/decl/sound_player/sound_player = GET_DECL(/decl/sound_player)
	return sound_player.PlayLoopingSound(source, sound_id, sound, volume, range, falloff, echo, frequency, prefer_mute, streaming)
...
/decl/sound_player/proc/PlaySoundDatum(var/atom/source, var/sound_id, var/sound/sound, var/range, var/prefer_mute, var/streaming)
	var/token_type = isnum(sound.environment) ? /datum/sound_token : /datum/sound_token/static_environment
	return new token_type(source, sound_id, sound, range, prefer_mute, streaming)

/decl/sound_player/proc/PlayLoopingSound(var/atom/source, var/sound_id, var/sound, var/volume, var/range, var/falloff = 1, var/echo, var/frequency, var/prefer_mute, var/streaming)
	...
	return PlaySoundDatum(source, sound_id, S, range, prefer_mute, streaming)
...
/datum/sound_token/New(var/atom/source, var/sound_id, var/sound/sound, var/range = 4, var/prefer_mute = FALSE, var/streaming)
	..()
	if(!istype(source))
