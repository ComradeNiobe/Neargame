...
datum/shuttle_controller/proc/recall()
	...
	if(direction == 1)
		...
		if(alert == 0)
			if(timeleft >= 600)
				return
			a.autosay("The Ulysses launch has been canceled.", "Ulysses Console")
...
datum/shuttle_controller/emergency_shuttle/process()
	...
	if((online) && (timeleft() < last60) && (direction == 1))
		if(timeleft > 60)
			...
			a.autosay("The Fortress will be abandoned in T - [round(emergency_shuttle.timeleft()/60)] min. His Lordship baron [lordShip] and his confidants are awaited on the Ulysses.", "CTTU")
			...
			a.autosay("The Fortress will be abandoned in T - [round(emergency_shuttle.timeleft()/60)] seconds. His Lordship baron [lordShip] and his confidants are awaited on the Ulysses.", "CTTU")
			...
			if(timeleft() > 0)
				...
				a.autosay("The Fortress will be abandoned in T - [round(emergency_shuttle.timeleft(),1)] seconds. His Lordship baron [lordShip] and his confidants are awaited on the Ulysses.", "CTTU")
			...
			if(last60 <= 6 && !launchmessage)
				...
				spawn(5)
					...
					a.autosay("The Ulysses has been launched. The Gate has been abandoned.", "CTTU")
