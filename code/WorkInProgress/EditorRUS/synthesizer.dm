...
/*
	...
	if(!edit)
		...
		dat += "Octave transpose: <A href='byond://?src=\ref[src];octave_down=1'>-</a> [octave_off] <a href='byond://?src=\ref[src];octave_up=1'>+</A><BR>"
		dat += "[classic ? "<A href='byond://?src=\ref[src];switch_mode=1'>Switch to modulated note</a>" : "<A href='byond://?src=\ref[src];switch_mode=2'>Switch to recorded notes</a>"]<br>"
		if (!classic)
			dat += "Current volume: <a href='byond://?src=\ref[src];change_volume=1'>[volume]</a><br>"
			dat += "Current instrument: <a href='byond://?src=\ref[src];change_instrument=1'>[instruments[instruments_A3files.Find(A3mod_note)]]</a><br>"
