...
/proc/Centcomm_fax(var/sent, var/sentname, var/mob/Sender)
	...
	var/msg = "\blue <b><font color='orange'>CENTCOMM FAX: </font>[key_name(Sender, 1)] (<A HREF='byond://?_src_=holder;adminplayeropts=\ref[Sender]'>PP</A>) (<A HREF='byond://?_src_=vars;Vars=\ref[Sender]'>VV</A>) (<A HREF='byond://?_src_=holder;subtlemessage=\ref[Sender]'>SM</A>) (<A HREF='byond://?_src_=holder;adminplayerobservejump=\ref[Sender]'>JMP</A>) (<A HREF='byond://?_src_=holder;secretsadmin=check_antagonist'>CA</A>) (<a href='byond://?_src_=holder;CentcommFaxReply=\ref[Sender]'>RPLY</a>)</b>: Receiving '[sentname]' via secure connection ... <a href='byond://?_src_=holder;CentcommFaxView=\ref[sent]'>view message</a>"
	admins << msg
