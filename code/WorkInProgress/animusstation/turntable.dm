...
/obj/machinery/party/turntable/attack_hand(mob/living/user as mob)
	...
	if(disk)
		t += "<A href='byond://?src=\ref[src];eject=1'>Eject disk</A><br>"
	t += "<tr><td height='50' weight='50'></td><td height='50' weight='50'><A href='byond://?src=\ref[src];off=1'><font color='red'>T</font><font color='lightgreen'>urn</font> <font color='red'>Off</font></A></td><td height='50' weight='50'></td></tr>"
	t += "<tr>"


	var/lastcolor = "red"
	for(var/i = 10; i <= 100; i += 10)
		t += "<A href='byond://?src=\ref[src];set_volume=[i]'><font color='[lastcolor]'>[i]</font></A> "
		if(lastcolor == "red")
			lastcolor = "red"
		else
			lastcolor = "red"
	...
	for(var/datum/turntable_soundtrack/D in turntable_soundtracks)
		t += "<td height='50' weight='50'><A href='byond://?src=\ref[src];on=\ref[D]'><font color='maroon'>[D.f_name]</font><font color='[lastcolor]'>[D.name]</font></A></td>"
		i++
		if(i == 1)
			lastcolor = "red"
		else
	...
	if(disk)
		if(disk.data)
			t += "<td height='50' weight='50'><A href='byond://?src=\ref[src];on=\ref[disk.data]'><font color='maroon'>[disk.data.f_name]</font><font color='[lastcolor]'>[disk.data.name]</font></A></td>"
		else
...
/obj/machinery/party/turntable/proc/turn_on(var/datum/turntable_soundtrack/selected)
	...
	sound_token = play_looping_sound(src, sound_id, track.path, volume = volume, range = 13, falloff = 3, prefer_mute = TRUE)
...
/obj/machinery/party/turntable/proc/turn_off()
	if(!playing)
		return
	sound_token = play_looping_sound(src, sound_id, track.path, volume = 0, range = 13, falloff = 3, prefer_mute = TRUE)
