...
//						usr << sound('nya.mp3')
				...
				dat += "<a href=\"byond://?src=\ref[src]&with=1\">Withdraw Physical Credits</a><br/>"
				dat += "<a href=\"byond://?src=\ref[src]&eca=1\">Eject Inserted Items</a><br/>"
				dat += "<a href=\"byond://?src=\ref[src]&ins=1\">Convert Inserted Items to Credits</a><br/>"
				dat += "<a href=\"byond://?src=\ref[src]&lock=1\">Lock ATM</a><br/>"
