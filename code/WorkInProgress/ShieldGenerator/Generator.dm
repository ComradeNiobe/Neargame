...
/obj/machinery/shielding/energyconverter/interact(mob/user as mob)
	...
	switch(OperatingMode)
		if(0)
			modec = {"<b>\[Off\]</b> <a href="byond://?src=\ref[src]&set=mode&mode=1">Manual</a> <a href="byond://?src=\ref[src]&set=mode&mode=2">Auto</a> <a href="byond://?src=\ref[src]&set=mode&mode=3">Remote</a>"}
		if(1)
			modec = {"<a href="byond://?src=\ref[src]&set=mode&mode=0">Off</a> <b>\[Manual\]</b> <a href="byond://?src=\ref[src]&set=mode&mode=2">Auto</a> <a href="byond://?src=\ref[src]&set=mode&mode=3">Remote</a>"}
		if(2)
			modec = {"<a href="byond://?src=\ref[src]&set=mode&mode=0">Off</a> <a href="byond://?src=\ref[src]&set=mode&mode=1">Manual</a> <b>\[Auto\]</b> <a href="byond://?src=\ref[src]&set=mode&mode=3">Remote</a>"}
		if(3)
			modec = {"<a href="byond://?src=\ref[src]&set=mode&mode=0">Off</a> <a href="byond://?src=\ref[src]&set=mode&mode=1">Manual</a> <a href="byond://?src=\ref[src]&set=mode&mode=2">Auto</a> <b>\[Remote\]</b>"}
...
Auto Mode Target Shield Charge %: <a href="byond://?src=\ref[src]&auto=1">M</a> <a href="byond://?src=\ref[src]&auto=2">--</a> <a href="byond://?src=\ref[src]&auto=3">-</a> [AutoTargetChargeLevel] <a href="byond://?src=\ref[src]&auto=4">+</a> <a href="byond://?src=\ref[src]&auto=5">++</a> <a href="byond://?src=\ref[src]&auto=6">M</a>
Manual Mode Generation Rate:      <a href="byond://?src=\ref[src]&man=1">M</a> <a href="byond://?src=\ref[src]&man=2">--</a> <a href="byond://?src=\ref[src]&man=3">-</a> [ManualConversionRate] <a href="byond://?src=\ref[src]&man=4">+</a> <a href="byond://?src=\ref[src]&man=5">++</a> <a href="byond://?src=\ref[src]&man=6">M</a>
</pre></body></html>"}
